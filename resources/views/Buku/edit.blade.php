...
@section('content')
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold">Edit Buku</h2>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full mx-auto border border-gray-100">
        <form action="{{ route('buku.update', $data_buku->id_buku) }}" method="POST" enctype="multipart/form-data"
            id="bukuForm" class="grid grid-cols-2 gap-8">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="judul_buku" id="judul_buku" value="{{ $data_buku->judul_buku }}"
                ...
                <div class="relative">
                    ...
                    <input type="file" name="foto" id="foto" accept="image/*" value="{{ $data_buku->foto }}"
            ...
            <div class="flex flex-col space-y-5">
                ...
                <div class="relative">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Tuliskan deskripsi singkat tentang buku..."
                        ...
                        required>{{ $data_buku->deskripsi }}</textarea>
                    @error('deskripsi')
                ...
                <div class="relative">
                    ...
                    <input type="number" name="stok" id="stok" min="0" value="{{ $data_buku->stok }}"
