...
@section('content')
    ...
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full mx-auto border border-gray-100">
        <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data" id="siswaForm"
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama" id="nama" placeholder="Contoh: Ivan Sandrea"
                        value="{{ old('nama') }}"
                ...
                <div class="relative">
                    ...
                    <select name="kelas" id="kelas"
                        ...
                        <option value="X-1" {{ old('kelas') == 'X-1' ? 'selected' : '' }}>X-1</option>
                        <option value="X-2" {{ old('kelas') == 'X-2' ? 'selected' : '' }}>X-2</option>
                        <option value="X-3" {{ old('kelas') == 'X-3' ? 'selected' : '' }}>X-3</option>
                        ...
                        <option value="XII-1" {{ old('kelas') == 'XII-1' ? 'selected' : '' }}>XII-1</option>
                        <option value="XII-2" {{ old('kelas') == 'XII-2' ? 'selected' : '' }}>XII-2</option>
                        <option value="XII-3" {{ old('kelas') == 'XII-3' ? 'selected' : '' }}>XII-3</option>
                    </select>
                ...
                <div class="relative">
                    ...
                    <img id="preview-foto_siswa" src="#" alt="Preview foto_siswa" class="absolute mt-2 h-20 rounded shadow border hidden">
                    @error('foto_siswa')
                        <p class="text-red-500 text-xs mt-2 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
            ...
            <div class="flex flex-col space-y-5">
                ...
                <div class="relative">
                    ...
                    <select name="jurusan" id="jurusan"
                        ...
                        <option value="TJAT" {{ old('jurusan') == 'TJAT' ? 'selected' : '' }}>TJAT</option>
